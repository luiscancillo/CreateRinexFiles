 ...
 */
void formatGPStime (char* buffer, int bufferSize, const char* fmtYtoM, const char * fmtSec, int week, double tow) {
 ...
 */
void formatLocalTime (char* buffer, int bufferSize, const char* fmt) {
